...
class Critic:
    ...
    def build_model(self):
        ...
        #net_states = layers.BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001, center=True, scale=True)(net_states)
        #net_states = layers.core.Activation('relu')(net_states)
        ...
        #net_actions = layers.BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001, center=True, scale=True)(net_actions)
        #net_actions = layers.core.Activation('relu')(net_actions)
